...
Contract v1. Host adapters follow these rules and replace the standalone CLI
...
Preserve source identity so repeat publishing updates the same document. Cancellation
publishes nothing and preserves the prepared artifact for reopening review. Return
only the successful publisher's public URL. A pending review is not a successful publish.
